...
import { Plus, Trash2, CheckCircle, Loader2, AlertTriangle, Briefcase, PiggyBank } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="p-8 space-y-8 animate-in fade-in duration-500">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Gérez vos initiatives et objectifs d'investissement</p>
        </div>

        <Tabs defaultValue="projets" className="space-y-6">
          <TabsList className="bg-white/[0.03] border border-white/[0.08] rounded-xl p-1 h-auto">
            <TabsTrigger
              value="projets"
              className="data-[state=active]:bg-gold data-[state=active]:text-black text-white/40 font-bold uppercase tracking-widest text-xs rounded-lg px-5 py-2.5 transition-all"
            >
            ...
            <TabsTrigger
              ...
              className="data-[state=active]:bg-gold data-[state=active]:text-black text-white/40 font-bold uppercase tracking-widest text-xs rounded-lg px-5 py-2.5 transition-all"
            >
              <PiggyBank className="h-3.5 w-3.5 mr-2" />
              Objectifs d'épargne
            </TabsTrigger>
          </TabsList>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center space-y-4 animate-in fade-in zoom-in duration-500">
                ...
                <div className="space-y-1">
                  <h3 className="text-xl font-bold text-white">Aucun projet en cours</h3>
                  <p className="text-muted-foreground text-sm">Créez-en un pour commencer !</p>
                </div>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
